...
def main():
    ...
    parser.add_argument('--save_dir', dest='save_dir', default='checkpoints/', help='Directory to save checkpoints')
    parser.add_argument('--arch', dest='arch', default='vgg16', choices=['vgg13', 'vgg16', 'resnet18'], help='Architecture (vgg16 or resnet18)')
    ...
    parser.add_argument('--epochs', dest='epochs', type=int, default=20, help='Number of epochs')
    ...
    save_checkpoint(model, class_to_idx, args.save_dir)
